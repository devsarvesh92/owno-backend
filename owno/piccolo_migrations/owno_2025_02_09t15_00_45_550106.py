...
class RealEstateProperty(Table, tablename="real_estate_property", schema=None):
    property_id = UUID(
        default=UUID4(),
        null=False,
        primary_key=True,
...
async def forwards():
    manager = MigrationManager(
        migration_id=ID, app_name="owno", description=DESCRIPTION
    )
    ...
    manager.add_table(
        class_name="UserFavoriteProperty",
        tablename="user_favorite_property",
        schema=None,
        columns=None,
    )

    manager.add_table(
        class_name="RealEstateProperty",
        tablename="real_estate_property",
        schema=None,
        columns=None,
    )
    ...
    manager.add_column(
        table_class_name="UserFavoriteProperty",
        tablename="user_favorite_property",
        column_name="user",
        db_column_name="user",
    ...
    manager.add_column(
        table_class_name="RealEstateProperty",
        tablename="real_estate_property",
